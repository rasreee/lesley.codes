---
slug: 'build-a-cmd-k-search-modal-1'
...
View the [demo](https://cmd-k-search-modal-react.vercel.app/).
...
Clone or fork the [Github repo](https://github.com/rasreee/cmd-k-search-tutorial-react) for the skeleton code.
...
Given the skeleton code, implement SearchModalProvider, SearchModalToggle, and SearchModal (and whatever else you want/have to implement to get the job done).
...
If you run into any issues with the tutorial, please feel free to open an issue against the [Github repo](https://github.com/rasreee/cmd-k-search-tutorial-react).
