...
<NotionAside>
	It's useful to write UI flow examples not only because it helps you understand the scenarios better, but also because you can then use it with a behavior-driven testing tool like [Cucumber](https://cucumber.io/) to write tests.
</NotionAside>
...
Let's create another component that uses this Modal component and render it as one of the children for SearchModalProvider:
