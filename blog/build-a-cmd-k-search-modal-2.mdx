...
5. The search modal briefly shows a loading indicator before showing "No results found for 'asdf'".
...
Let's implement the Modal component which will be used by SearchModal to wrap its children.
