      ...
      <div className="flex flex-col items-start justify-center max-w-2xl mx-auto mb-16">
        ...
        <div className="relative w-full mb-4">
          <input
            ...
            className="block w-full px-4 py-2 text-gray-900 border border-gray-200 rounded-md dark:border-gray-900 focus:ring-blue-500 focus:border-blue-500 highlight-bg dark:text-gray-100"
          />
          <svg
